...
public class CollisionDetectionExample extends BaseExample {
  ...
  public Scene onLoadScene() {
    ...
    centerRectangle.addShapeModifier(new LoopShapeModifier(
        new ParallelShapeModifier(new RotationModifier(6, 0, 360),
            new SequenceShapeModifier(new ScaleModifier(3, 1, 1.5f),
