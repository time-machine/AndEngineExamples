...
public class RectangleExample extends BaseExample {
  ...
  public Scene onLoadScene() {
    ...
    // create 3 lines that will form an arrow pointing to the eye
    ...
    final Rectangle subRectangle = new Rectangle(45, 45, 90, 90) {
      ...
      protected void onManagedUpdate(final float pSecondsElapsed) {
        ...
        final float[] upperLeftCoordinates = convertLocalToSceneCoordinates(0, 0);
        final float upperLeftX = upperLeftCoordinates[VERTEX_INDEX_X];
        final float upperLeftY = upperLeftCoordinates[VERTEX_INDEX_Y];

        arrowLineMain.setPosition(upperLeftX, upperLeftY, upperLeftX,
            upperLeftY - 50);
        arrowLineWingLeft.setPosition(upperLeftX, upperLeftY, upperLeftX - 10,
            upperLeftY - 10);
        arrowLineWingRight.setPosition(upperLeftX, upperLeftY, upperLeftX + 10,
            upperLeftY - 10);
      }
    };
